...
// 0 is not used
// 1 is 100k thermistor - best choice for EPCOS 100k (4.7k pullup) - on E3D-online hot ends
...
#define DISABLE_INACTIVE_EXTRUDER true //disable only inactive extruders and keep active extruder enabled (needed for Windows compilation to work)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.0,80.0,4000.0,700}  // default steps per unit for i3
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.0,78.7402,2560.0,750.0}  // default steps per unit for ORD bot
...
// Preheat Constants
#define PLA_PREHEAT_HOTEND_TEMP 193
